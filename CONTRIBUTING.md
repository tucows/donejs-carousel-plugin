# Contributing to donejs-carousel-plugin
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork donejs-carousel-plugin, you can start by going to its [fork page](https://github.com/Tucows/donejs-carousel-plugin/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/donejs-carousel-plugin
```
