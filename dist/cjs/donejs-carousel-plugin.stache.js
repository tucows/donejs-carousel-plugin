/*@tucows/donejs-carousel-plugin@0.3.0#donejs-carousel-plugin.stache!steal-stache@3.1.3#steal-stache*/
var stache = require('can-stache');
var mustacheCore = require('can-stache/src/mustache_core');
require('can-view-import@3.2.9#can-view-import');
require('can-stache-bindings@3.11.12#can-stache-bindings');
var renderer = stache('donejs-carousel-plugin.stache', [
    ...
    },
    {
        'tokenType': 'attrStart',
        'args': [
            'http::f::f:www.w3.org:f:2000:f:svg"',
            78
        ]
    },
    {
